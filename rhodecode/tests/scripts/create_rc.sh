...
rhodecode-api --apikey=$API_KEY --apihost=http://127.0.0.1:5001 add_user_to_users_group usergroupid:demo12 userid:demo1
rhodecode-api --apikey=$API_KEY --apihost=http://127.0.0.1:5001 add_user_to_users_group usergroupid:demo12 userid:demo2
echo "killing server"
kill `cat rc.pid`
rm rc.pid
